'''
File: Contains the code to test learning real-valued distances, binned-distances and contact maps
'''
...
for my_eval_set in evalsets:
    ...
    model = QCNN_RDD_Distances(arch_depth, filters_per_layer, expected_n_channels)
    if use_cuda:
        model.cuda()
